...
time.sleep(5)  # Aguarda 5 segundos para você posicionar o mouse
print(pyautogui.position()) # Obtém a posição atual do mouse e imprime no console


# Saída esperada da tabela de produtos (produtos.csv).
